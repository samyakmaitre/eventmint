...
function Header({ onSearch }) { 
    ...
    return (
        <>
            <header className={`header container-fluid d-flex align-items-center justify-content-between p-3 ${scrolled ? 'scrolled' : ''}`} style={{backgroundColor: mode === "dark" ? "black" : "", boxShadow: mode === "dark" ? "0 4px 4px rgba(255, 255, 255, 0.2)" : "" }}>
                <style>
                    {`
                    .header {
                        position: sticky;
